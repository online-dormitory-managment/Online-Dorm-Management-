...
require('dotenv').config({ path: './server/.env' }); // Adjusted path for running from root
...
const seedData = async () => {
    try {
        ...
        // Clear existing (optional, maybe just add if empty)
        ...
        const events = [
            ...
            },
            {
                ...
                category: 'Other' // Inspection mapped to Other or we update enum
            },
            {
